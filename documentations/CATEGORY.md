...
This document outlines the purpose and structure of the `categories` table within the **Thai Health Product** project. It is designed to support high-performance e-commerce features, including hierarchical menus, localized content, and SEO optimization.
