...
//* PRODUCT ROW. A SIMPLE product contributes itself; a VARIABLE product
//* contributes one entry per variant instead of its own row, since the
//* variant (not the parent product) is what a select/lookup field actually
//* needs to reference — e.g. "Colette Collins 23 July variant 200 ml" and
//* "Colette Collins 23 July variant 30 Capsules" as two distinct options.
//* ═══════════════════════════════════════════════════════════════════════
export class ProductDropdownOptionDto {
  @Expose()
